...
public class LifeSkillsActivity extends AppCompatActivity {
    ...
    FrameLayout life_skills_layout,no_network;
    TextView activities_desc,about_desc,no_network_text;
    LinearLayout life_skills_items;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        life_skills_layout= (FrameLayout) findViewById(R.id.mentor_layout);
        no_network= (FrameLayout) findViewById(R.id.no_network);
        no_network_text= (TextView) findViewById(R.id.no_network_text);
        life_skills_items= (LinearLayout) findViewById(R.id.mentor_items);
        avi= (AVLoadingIndicatorView) findViewById(R.id.avi);

        //hiding layouts while progress bar loadings
        life_skills_items.setVisibility(View.GONE);
            ...
            asyncHttpClient.post("http://www.kimesh.com/pambio/what_we_do.php", new TextHttpResponseHandler() {
                ...
                public void onSuccess(int i, Header[] headers, String s) {
                    ...
                    YoYo.with(Techniques.FadeInUp)
                            .duration(900)
                            .repeat(0)
                            .playOn(life_skills_layout);
                    avi.smoothToHide();
                    life_skills_items.setVisibility(View.VISIBLE);
                    try {
                        JSONArray contact_items=new JSONArray(s);

                        JSONObject on_mentor=contact_items.getJSONObject(5);
                        try {
