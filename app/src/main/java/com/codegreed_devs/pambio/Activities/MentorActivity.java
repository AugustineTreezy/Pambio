...
public class MentorActivity extends AppCompatActivity {
    ...
    FrameLayout mentor_layout,no_network;
    TextView activities_desc,about_desc,no_network_text;
    LinearLayout mentor_items;
            ...
            asyncHttpClient.post("http://www.kimesh.com/pambio/what_we_do.php", new TextHttpResponseHandler() {
                ...
                public void onSuccess(int i, Header[] headers, String s) {
                    ...
                    YoYo.with(Techniques.FadeInUp)
                            .duration(900)
                            .repeat(0)
                            .playOn(mentor_layout);
                    avi.smoothToHide();
                    mentor_items.setVisibility(View.VISIBLE);
                    try {
                        JSONArray contact_items=new JSONArray(s);

                        JSONObject on_mentor=contact_items.getJSONObject(0);
                        try {
