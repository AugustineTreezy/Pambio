...
public class PeaceEduActivity extends AppCompatActivity {
    AVLoadingIndicatorView avi;
    FrameLayout peace_edu_layout,no_network;
    TextView activities_desc,activities,about_desc,no_network_text;
    LinearLayout peace_edu_items;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        peace_edu_layout= (FrameLayout) findViewById(R.id.mentor_layout);
        no_network= (FrameLayout) findViewById(R.id.no_network);
        no_network_text= (TextView) findViewById(R.id.no_network_text);
        peace_edu_items= (LinearLayout) findViewById(R.id.mentor_items);
        ...
        peace_edu_items.setVisibility(View.GONE);
        activities_desc.setVisibility(View.GONE);
            ...
            asyncHttpClient.post("http://www.kimesh.com/pambio/what_we_do.php", new TextHttpResponseHandler() {
                ...
                public void onSuccess(int i, Header[] headers, String s) {
                    ...
                    YoYo.with(Techniques.FadeInUp)
                            .duration(900)
                            .repeat(0)
                            .playOn(peace_edu_layout);
                    avi.smoothToHide();
                    peace_edu_items.setVisibility(View.VISIBLE);
                    try {
                        JSONArray contact_items=new JSONArray(s);

                        JSONObject on_mentor=contact_items.getJSONObject(3);
                        try {
